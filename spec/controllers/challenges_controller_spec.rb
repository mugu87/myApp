...
describe ChallengesController do
  ...
  let(:valid_attributes) { { "cost_per_completion" => "1.5" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved challenge as @challenge" do
        ...
        post :create, {:challenge => { "cost_per_completion" => "invalid value" }}, valid_session
        assigns(:challenge).should be_a_new(Challenge)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested challenge" do
        ...
        Challenge.any_instance.should_receive(:update).with({ "cost_per_completion" => "1.5" })
        put :update, {:id => challenge.to_param, :challenge => { "cost_per_completion" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the challenge as @challenge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Challenge.any_instance.stub(:save).and_return(false)
        put :update, {:id => challenge.to_param, :challenge => { "cost_per_completion" => "invalid value" }}, valid_session
        assigns(:challenge).should eq(challenge)
      end
